...
def func2matrix_IO(language, MatrixA):
    line = []
    if language == 'matlab': # the type like matlab
        for ii in range(len(MatrixA)):
            tmp = []
            for matrix in MatrixA[ii]:
                if not tmp:
                    tmp = matrix+', '
                else:
                    tmp = tmp+matrix+', '
    ...
    elif language == 'python': # the type like python
        for ii in range(len(MatrixA)):
            tmp = []
            for matrix in MatrixA[ii]:
                if not tmp:
    ...
    elif language == 'None': # the type without any style
        for ii in range(len(MatrixA)):
            tmp = []
            for matrix in MatrixA[ii]:
                if not tmp:
